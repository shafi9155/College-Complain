...
//  },[dropdown])
  ...
  const getUser = async () => {
    ...
    const url = `/api/students/getStudent/${SingleComplain.user_id}`;
 ...
 useEffect(()=>{
  ...
  const escalteCmpln = async () => {
    ...
    const url = `/api/complain//escalateComplain/${SingleComplain._id}`;
  ...
  const  closeComplain = async () => {
    ...
    const url = `/api/complain/closeComplain/${SingleComplain._id}`;
