...
//  },[dropdown])
  ...
  const getUser = async () => {
    ...
    const url = `https://college-complaint.onrender.com/api/students/getStudent/${SingleComplain.user_id}`;
 ...
 useEffect(()=>{
  ...
  const escalteCmpln = async () => {
    ...
    const url = `https://college-complaint.onrender.com/api/complain//escalateComplain/${SingleComplain._id}`;
  ...
  const  closeComplain = async () => {
    ...
    const url = `https://college-complaint.onrender.com/api/complain/closeComplain/${SingleComplain._id}`;
